-- Insert users
INSERT INTO carpool_user (id, name, university_id, created_at, updated_at)
VALUES
    ('U1', 'Alice Johnson', 101, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('U2', 'Bob Smith', 102, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('U3', 'Charlie Brown', 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
    (TIMESTAMP '2025-02-20 08:30:00', 3, 10.5, 'Morning commute to university', 'U2', 1, 1, 2),
...
VALUES
    (CURRENT_TIMESTAMP, 'Hey, what time should we meet?', 'U1', 'U2', 1, 1),
    (CURRENT_TIMESTAMP, 'See you at 8:15 AM!', 'U2', 'U1', 1, 2);

-- Insert users joining rides
INSERT INTO users_have_rides (user_id, ride_id) VALUES ('U1', 1);
INSERT INTO users_have_rides (user_id, ride_id) VALUES ('U1', 2);
